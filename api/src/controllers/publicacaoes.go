...
func AtualizarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	if publicacaoBanco.AutorID != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("usuário não pode alterar publicação de outro usuário"))
		return
	}
...
func ExcluirPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	if publicacaoBanco.AutorID != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("usuário não pode excluir publicação de outro usuário"))
		return
	}
